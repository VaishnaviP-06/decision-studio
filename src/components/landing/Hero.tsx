  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute left-20 top-10 h-72 w-72 round ed-full bg-indigo-500/10 blur-3xl" />
      ...
      <div className="mx-auto flex min-h-[90vh] max-w-7xl flex-col items-center justify-between gap-16 px-6 py-20 lg:flex-row">
        ...
        className="h-[500px] w-full max-w-xl overflow-hidden rounded-3xl border border-[var(--border)] bg-[var(--surface)] shadow-2xl"
        >
        <DecisionPreview />
        </motion.div>
      </div>
